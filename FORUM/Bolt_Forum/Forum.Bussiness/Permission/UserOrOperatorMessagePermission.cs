...
namespace Com.Comm100.Forum.Bussiness
{
    public class UserOrOperatorMessagePermission : UserOrOperatorPermissionBase, IMessagePermission
    {
        ...
        public UserOrOperatorMessagePermission(SqlConnection generalConn, SqlTransaction generalTransaction, SqlConnectionWithSiteId siteConn, SqlTransaction siteTransaction, int userOrOperatorId)
