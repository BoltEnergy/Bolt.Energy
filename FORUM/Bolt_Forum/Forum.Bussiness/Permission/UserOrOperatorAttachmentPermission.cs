...
namespace Com.Comm100.Forum.Bussiness.Permission
{
    public class UserOrOperatorAttachmentPermission : UserOrOperatorPermissionBase, IAttachmentPermission
    {
        ...
        public UserOrOperatorAttachmentPermission(SqlConnection generalConn, SqlTransaction generalTransaction, SqlConnectionWithSiteId siteConn, SqlTransaction siteTransaction, int userOrOperatorId)
