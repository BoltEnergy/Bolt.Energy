...
namespace Com.Comm100.Forum.Bussiness
{
    public class UserOrOperatorPermissionBase
    {
        ...
        protected int _userOrOperatorId;
        ...
        public UserOrOperatorPermissionBase(SqlConnection generalConn, SqlTransaction generalTransaction, SqlConnectionWithSiteId siteConn, SqlTransaction siteTransaction, int userOrOperatorId)
        { }
    }
}
