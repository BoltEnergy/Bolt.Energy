...
namespace Com.Comm100.Forum.Bussiness
{
    public class GuestUserSearchPermission : GuestUserPermissionBase, ISearchPermission
    {
        ...
        public GuestUserSearchPermission(SqlConnection generalConn, SqlTransaction generalTransaction, SqlConnectionWithSiteId siteConn, SqlTransaction siteTransaction, Int64 ip)
