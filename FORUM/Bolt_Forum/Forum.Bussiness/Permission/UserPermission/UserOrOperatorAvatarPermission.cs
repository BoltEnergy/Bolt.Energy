...
namespace Com.Comm100.Forum.Bussiness
{
    public class UserOrOperatorAvatarPermission : UserOrOperatorPermissionBase, IAvatarPermission
    {
        ...
        public UserOrOperatorAvatarPermission(SqlConnection generalConn, SqlTransaction generalTransaction, SqlConnectionWithSiteId siteConn, SqlTransaction siteTransaction, UserOrOperator userOrOperator)
