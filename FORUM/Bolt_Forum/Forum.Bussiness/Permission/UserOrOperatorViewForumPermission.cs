...
namespace Com.Comm100.Forum.Bussiness
{
    public class UserOrOperatorViewForumPermission : UserOrOperatorPermissionBase, IViewForumPermission
    {
        ...
        public UserOrOperatorViewForumPermission(SqlConnection generalConn, SqlTransaction generalTransaction, SqlConnectionWithSiteId siteConn, SqlTransaction siteTransaction, int userOrOperatorId, int forumId)
