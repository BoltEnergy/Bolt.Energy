...
{
    public class ScoreStrategySettingWithPermissionCheck : ScoreStrategySetting
    {
        UserOrOperator _operatingUserOrOperator;

        public ScoreStrategySettingWithPermissionCheck(SqlConnectionWithSiteId conn, SqlTransaction transaction, UserOrOperator operaingUseOrOperator, int siteId)
            : base(conn, transaction, siteId)
        {
            _operatingUserOrOperator = operaingUseOrOperator;
        }
