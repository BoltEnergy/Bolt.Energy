<%@ Page Title="" Language="C#" MasterPageFile="~/ModeratorPanel/ModeratorMasterPage.Master"
    AutoEventWireup="true" CodeBehind="Posts.aspx.cs" Inherits="Com.Comm100.Forum.UI.ModeratorPanel.TopicAndPost.Posts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divSubTitle">
        <asp:Label ID="lblSunTitle" runat="server"></asp:Label>
    </div>
    <br />
    <div class="divMsg">
        ...
        <div class="divTable">
            <center>
                <table class="form-table">
                    <%--<tr>
                        <td class="ttd" width="250px">
                            <%=Proxy[EnumText.enumForum_Topic_FieldTopicId] %>
                        </td>
                        <td class="ctd" width="350px"">
                    ...
                    <tr>
                        <td class="ttd">
                            <%=Proxy[EnumText.enumForum_Topic_FieldForum] %>
                        </td>
                        <td class="ctd">
                ...
                <asp:Repeater ID="rptData" runat="server" OnItemCommand="rpData_ItemCommand">
                    <ItemTemplate>
                        <tr class="trStyle<%#(this.rptData.Items.Count)%2%>" onmousedown="highLightRow(this)">
                            <td>
                                <span class="linkTopic"><a href="../../Topic.aspx?siteId=<%=SiteId%>&topicId=<%#Eval("TopicId")%>&postId=<%#Eval("PostId") %>&forumId=<%# GetForumId(Convert.ToInt32(Eval("TopicId")))%>&goToPost=true#Post<%#Eval("PostId") %>"
                            ...
                            <td style="text-align: center">
                                <a href="../../EditTopicOrPost.aspx?siteId=<%=SiteId%>&postId=<%#Eval("PostId")%>&topicId=<%#Eval("TopicId")%>&forumId=<%#GetForumId(Convert.ToInt32(Eval("TopicId")))%>"
                                    target="_blank" />
                                <img title="<%#Proxy[EnumText.enumForum_Post_HelpEdit] %>" alt="<%#Proxy[EnumText.enumForum_Post_HelpEdit] %>"
...
<asp:Content ID="ContentThickBox" ContentPlaceHolderID="cphThickBox" runat="server">
    ...
    <div class="divContent" style="border: solid 3px #aaa; padding: 10px 5px 10px 5px; width:720px; height: 560px;">
