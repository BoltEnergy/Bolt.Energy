<%@ Page Title="" Language="C#" MasterPageFile="~/ModeratorPanel/ModeratorMasterPage.Master"
    AutoEventWireup="true" CodeBehind="ForumPermission.aspx.cs" Inherits="Com.Comm100.Forum.UI.ModeratorPanel.Forum.ForumPermission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divContent">
        <div class="divTopButton">
            <asp:Button ID="btnSaveUserGroup1" runat="server" CssClass="mbtn" OnClick="btnUserGroupSave_Click"
            ValidationGroup="add">
            </asp:Button>
            <input type="button" class="mbtn" value="<%=Proxy[EnumText.enumForum_Forums_ButtonReturn] %>"
                onclick="window.location='Forums.aspx?siteId=<%=SiteId %>'" />
        </div>
        <div class="divTable">
            <div>
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td class="ctd" colspan="2" style="padding-left: 4px;">
                            ...
                            <%--<span>
                                <img src="../../Images/help.gif" style="margin-bottom: -2px;" alt="" onmouseover="showHelp('divHelp','<%=Proxy[EnumText.enumForum_Forums_AdditionalInformation]%>');"
                    ...
                    <tr>
                        ...
                        <td class="ctd" colspan="2">
                            ...
                            <div id="dvCustomDescription" style="display: none;">
                               <%-- <%=Proxy[EnumText.enumForum_Forums_CustomDescription]%>--%>
        ...
        <div id="trPermissions" style="padding-left: 55px; padding-right: 25px"">
                        ...
                        <li style="<%=VisibleUserGroups%>">
                            <asp:LinkButton ID="lkbUserGroups" runat="server" OnClientClick="changeTabStyle(1);"
                                CssClass="aSel" OnClick="lkbUserGroups_Click" Style="text-decoration: none">
                                    <span class="spanSel"><%=Proxy[EnumText.enumForum_Forums_ForumPermissionTabUserGroups] %></span>
                            </asp:LinkButton>
                        </li>
            ...
            <div id="tabPage" style="border: none; margin-bottom: 10px;">
                <table width="100%" cellpadding='0' cellspacing="0">
                    <tr>
                        <td class="ctd" style="padding-left: 4px; vertical-align: top; vertical-align: top;">
                            <div id="divGroupItems">
                                <div id="divUserGroupInForum" style="height: auto;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr class="divAddButton">
                                            <td>
                                                ...
                                                <tr id='divUserGroupItem<%# Eval("usergroupId") %>' class="divGroupItem" onclick="setHighLightDIV(this)">
                                                    <td>
                                                        <div style="float: left; width: 90%; display: block; text-align: left">
                                                            <asp:LinkButton ID="lbtnName" runat="server" Text='<%#Server.HtmlEncode(Convert.ToString(Eval("Name")))%>'
                                                        ...
                                                        <div style="float: right; width: 10%;">
                                                            <asp:ImageButton ID="ibtnGroupDel" runat="server" ImageUrl="~/Images/database_delete.gif"
                                                                OnClick="ibtnGroupDel_Click" CommandArgument='<%# Eval("usergroupId") %>' />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                ...
                                <div id="divReputationGroupInForum" style="display: none; height: auto;">
                                                    ...
                                                    <td>
                                                        <div style="float: left; width: 90%; display: block; text-align: left">
                                                            <asp:LinkButton ID="lbtnName" runat="server" Text='<%# Server.HtmlEncode(Convert.ToString(Eval("Name"))) %>'
                                                                ...
                                                                Style="display: block; width: 100%; text-decoration: none"></asp:LinkButton>
                                                        </div>
                                                        <div style="float: right; width: 10%;">
                        ...
                        <td class="ctd" style="border: solid 10px #ffffff">
                            <div id="divGroupPermission" runat="server">
                                <table width="100%" id="tblPermissionsSet">
                                    ...
                                    <tr>
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblViewTopic" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="30%" align="right" nowrap="nowrap" class="style1">
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblPostTopicOrPost" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="30%" align="right" nowrap="nowrap" class="style1">
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblMinIntervalPost" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="30%" align="right" nowrap="nowrap" class="style1">
                                        ...
                                        <td width="10">
                                            <asp:TextBox ID="txtMaxPostLength" CssClass="txtshortScore" runat="server" customattr="1000"
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblMaxPostLength" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="30%" align="right" nowrap="nowrap" class="style1">
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblAllowURL" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="30%" align="right" nowrap="nowrap" class="style1">
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblAllowImage" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="30%" align="right" nowrap="nowrap" class="style1">
                                        ...
                                        <td width="60%">
                                            <asp:Label ID="lblPostNotModeration" runat="server" CssClass="helpMsg" Visible="true"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <%--<div id="divGp2" style="display: none; border: solid 2px #d7e7ee; width: 550px; height: 310px;
                                background-color: #ffffff">
                                Please Select a User group or Reputation group. &nbsp;</div>--%>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="divButtomButton">
            <asp:Button ID="btnSaveUserGroup2" runat="server" CssClass="mbtn" OnClick="btnUserGroupSave_Click"
            ValidationGroup="add">
            </asp:Button>
            <input type="button" class="mbtn" onclick="window.location='Forums.aspx?siteId=<%=SiteId %>'"
...
<asp:Content ID="ContentThickBox" ContentPlaceHolderID="cphThickBox" runat="server">
                ...
                <div class="divh-header">
                    <div style="float: left; font-size: 1.1em;">
                        <span class="divh-header-spantitle">
                            <asp:Label ID="lblSelectUserGroupTitle" runat="server"><%=Proxy[EnumText.enumForum_Forums_forumPermissionTitleAddUserGroup] %></asp:Label></span>
                    </div>
                ...
                <input class="mbtn" type="button" value='Cancel' onclick="WindowClose('divUserGroupNotInForum','divThickOuter'); return false;" />
                        ...
                        <div class="divTable" style="text-align: center">
                            <table class="form-table">
                                ...
                                <%--<div id="divUserGroup" runat="server">--%>
                                <asp:Repeater ID="rpUserGroupNotInForum" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="ctd" style="text-align: left">
                                                <asp:CheckBox ID="chbGroup" runat="server" Text='<%#Server.HtmlEncode(Eval("name").ToString()) %>' />
                                            </td>
                                            <td>
                                                <asp:Label ID="lblGroupId" runat="server" Text='<%# Server.HtmlEncode(Convert.ToString(Eval("usergroupid"))) %>'
   ...
   <%-- <div id="" style="position: absolute; height: auto; display: none;
        width: 600px; border: solid 3px #aaa; padding: 5px 5px 5px 5px; background-color: #fff;">
    </div>--%>
    <div id="divReputationGroupNotInForum" style="position: absolute; height: auto;
       ...
       <div class="divh">
            <div class="divh-header">
                <div style="float: left; font-size: 1.1em;">
                    <span class="divh-header-spantitle">
                        <asp:Label ID="lblSelectReputationGroups" runat="server"><%=Proxy[EnumText.enumForum_Forums_forumPermissionTitleAddReputationGroup] %></asp:Label></span>
                </div>
                <%--<div style="float: right;">
            ...
            <div class="divh-table">
                <div class="divContent">
                    <%--<div class="divTopButton">
                <asp:Button ID="btnAddGroup3" runat="server" Text="Save" OnClick="btnAddReputationGroup_Click"
                    CssClass="mbtn"></asp:Button>
                <input class="mbtn" type="button" value='Cancel' onclick="WindowClose('divReputationGroupNotInForum','divThickOuter'); return false;" />
                    ...
                    <div class="divTable" style="text-align: center">
                        <table class="form-table">
                            ...
                            <div id="divReputationGroup" runat="server">
                                <asp:Repeater ID="rpReputationGroupsNotInForum" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblGroupId" runat="server" Text='<%# Server.HtmlEncode(Eval("groupid").ToString()) %>'
                                                    Visible="false"></asp:Label>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
    ...
    <%--<div id="" style="position: absolute; display: none;
        height: auto; width: 600px; background-color: #fff; border: solid 3px #aaa; padding: 5px 5px 5px 5px;">
