<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="ReputationStrategy.aspx.cs" Inherits="Com.Comm100.Forum.UI.AdminPanel.Settings.ReputationStrategy" %>
            ...
            <table id="form-table" class="form-table" width="100%">
                <tr>
                    ...
                    <td class="ttd" style="text-align: center;">
                        <span class="Font3"><%=Proxy[EnumText.enumForum_Settings_Reputations]%></span>
                    </td>
                    <td class="ttd" >
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std">
                        <asp:TextBox ID="txtI_Register" runat="server" CssClass="txtshortScore"></asp:TextBox>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationRegister]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationFirstLogin]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationModeratorAdded]%> </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationModeratorRemoved]%> </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationUserAccountBanned]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationUserAccountUnbanned]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicPosted]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationMakeAsFeature]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicSticky]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicDeleted]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicRestored]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicAddedIntoFavorites]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicRemovedFromFavorites]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicViewed]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicReplied]%> </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationTopicVerifiedAsSpam]%> </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std">
                        ...
                        <asp:RangeValidator ID="rvI_VoteForaPoll" runat="server" 
                            ControlToValidate="txtI_VoteForaPoll" Display="Dynamic" MaximumValue="2147483647" 
                            MinimumValue="-2147483648" Type="Integer" ValidationGroup="Save"></asp:RangeValidator>
                    </td>
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationVoteforaPoll]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationPollVoted]%></span>
                    </td>
                </tr>
                <!-- Topic End -->
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationNewPost]%> </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationPostDeleted]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationPostRestored]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationPostVerifiedAsSpam]%></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationPostMarkAsAnswer]%></span>
                    </td>
                </tr>
                <!-- Post End -->
                ...
                <tr>
                    ...
                    <td class="std">
                        ...
                        <asp:RangeValidator ID="rvI_ReportAbuse" runat="server" 
                            ControlToValidate="txtI_ReportAbuse" Display="Dynamic" MaximumValue="2147483647" 
                            MinimumValue="-2147483648" Type="Integer" ValidationGroup="Save"></asp:RangeValidator>
                    </td>
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationReportAbuse]%> </span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="std" >
                    <span class="helpMsg">
                        <%=Proxy[EnumText.enumForum_Settings_HelpReputationSearch]%></span>
                    </td>
                </tr>
                <!-- Other End -->
