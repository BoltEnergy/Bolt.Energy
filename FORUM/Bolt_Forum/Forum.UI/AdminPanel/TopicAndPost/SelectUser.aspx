<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectUser.aspx.cs" Inherits="Com.Comm100.Forum.UI.AdminPanel.TopicAndPost.SelectUser" %>
...
<body>
    ...
    <div id="Content" style="margin-left: 0px;">
        ...
        <div class="divContent">
            <div class="divTopButton">
                <asp:Button ID="btnSelect1" runat="server" OnClientClick="javascript:GetSelectUsers();return false;"
                    CssClass="mbtn" />
            ...
            <div class="divTable">
                <table class="the-table" cellpadding='0' cellspacing='0'>
                    <tr>
                        ...
                        <%-- <th  width="10%" style="padding-left: 10px; font-size: 11px; border: 0px">
