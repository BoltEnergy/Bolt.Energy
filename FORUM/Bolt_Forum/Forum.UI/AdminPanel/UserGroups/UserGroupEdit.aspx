<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="UserGroupEdit.aspx.cs" Inherits="Com.Comm100.Forum.UI.AdminPanel.UserGroups.UserGroupEdit" %>
    ...
    <div class="divContent">
        ...
        <table class="form-table">
            <tr>
                ...
                <td class="rtd">
                    *
                    <asp:RequiredFieldValidator ID="requiredName" runat="server" ControlToValidate="txtName" Display="Dynamic"></asp:RequiredFieldValidator>
