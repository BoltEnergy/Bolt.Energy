<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="PermissionSet.aspx.cs" Inherits="Com.Comm100.Forum.UI.AdminPanel.UserGroups.PermissionSet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divContent">
        ...
        <table class="form-table">
            <tr>
                <td class="ttd">
                    <%=Proxy[EnumText.enumForum_UserGroups_FieldCurrentUserGroup] %>
                </td>
                <td class="ctd">
                ...
                <td class="ctd">
                    <table class="tblPermissionsSet">
                        ...
                        <tr>
                            ...
                            <td class="ctd" style="vertical-align:middle">
                        ...
                        <tr>
                            ...
                            <td class="ctd">
                                ...
                                <asp:CompareValidator ID="cvMaxMessage" runat="server" Display="Dynamic" Type="Integer" ValueToCompare="0"
        ...
        <div class="divButtomButton">
            <asp:Button ID="btnSave2" runat="server"  class="mbtn" 
            OnClick="btnSave_Click" ValidationGroup="add" />
