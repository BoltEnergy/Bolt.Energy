<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="EditAnnoucement.aspx.cs" Inherits="Com.Comm100.Forum.UI.AdminPanel.Annoucement.EditAnnoucement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="divTitle">
        <span class="TitleLabel">
            <asp:Label ID="Label2" runat="server">Edit Announcement</asp:Label></span></div>
    <div class="divSubTitle">
        Here you can edit an announcement.
    </div>
    <br />
    <div class="divMsg">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td class="ctd">
                        ...
                        <asp:RequiredFieldValidator ID="rfvSuject" runat="server" ErrorMessage="Subject is required"
