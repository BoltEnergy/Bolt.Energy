<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="EditAnnouncement.aspx.cs" Inherits="Com.Comm100.Forum.UI.AdminPanel.Announcement.EditAnnouncement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function checkForum(object, args) {
            alert(1);
            var forumList = document.getElementById("<%=listBoxForum.ClientID %>");
            var haveSelected = false;
            for (var i = 0; i < forumList.options.length; i++) {
                if (forumList.options[i].selected) {
                    haveSelected = true;
                    break;
                }
            }
            alert(haveSelected);
            args.IsValid = haveSelected;
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="divContent">
        <div class="divTopButton">
            ...
            <asp:Button ID="btnCancel1" runat="server" CssClass="mbtn" onclick="btnCancel1_Click" CausesValidation="false" />
        </div>
        <div class="divTable">
            <br />
            <table class="form-table">
                <tr>
                    ...
                    <td class="ctd">
                        ...
                        <asp:RequiredFieldValidator ID="rfvSuject" runat="server" ControlToValidate="tbSubject" ValidationGroup="Save"></asp:RequiredFieldValidator>
                    </td>
                    <td>
                    </td>
                </tr>
                ...
                <%--<tr>
                    ...
                    <td class="ctd" id="divBeginTime">
                        ...
                        <asp:RequiredFieldValidator ID="rfvBeginDate" runat="server" ControlToValidate="txtStartTime" Display="Dynamic" ValidationGroup="Save"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td class="ctd">
                        ...
                        <img onclick="WdatePicker({el:$dp.$('ctl00_ContentPlaceHolder1_txtExpireTime')})"
                            ...
                            height: 20px;" />
                        <span class="alertMsg" style="color: Red">*</span> (MM-dd-yyyy)
                        <asp:RequiredFieldValidator ID="rfvExpireDate" runat="server" ControlToValidate="txtExpireTime" Display="Dynamic" ValidationGroup="Save"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td class="ctd">
                        <asp:ListBox ID="listBoxForum" runat="server" SelectionMode="Multiple" Height="200px"></asp:ListBox>
                        <span class="alertMsg" style="color: Red">*</span>
                        <asp:CustomValidator ID="cvForum" ControlToValidate="listBoxForum" runat="server" ValidateEmptyText="false" ValidationGroup="Save"></asp:CustomValidator>
                    </td>
                    <td>
                    </td>
                </tr>
