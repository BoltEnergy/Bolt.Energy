<%@ Page Title="Forums" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.Master"
    AutoEventWireup="true" CodeBehind="ForumEdit.aspx.cs" Inherits="Forum.UI.AdminPanel.Forums.ForumEdit"
    ...
    <div class="divContent">
        ...
        <div class="divTable">
            ...
            <table class="form-table">
                <tr>
                    <td class="ttd">
                        <%=Proxy[EnumText.enumForum_Forums_FieldName]%>
                    </td>
                    <td class="ctd" style="width: 351px">
                ...
                <tr>
                    <td class="ttd">
                        <%=Proxy[EnumText.enumForum_Forums_FieldDescription]%>
                    </td>
                    <td class="ctd" style="width: 351px">
                ...
                <tr>
                    <td class="ttd">
                        <%=Proxy[EnumText.enumForum_Forums_FieldCategory]%>
                    </td>
                    <td class="ctd" style="width: 351px">
                ...
                <tr>
                    <td class="ttd">
                        <%=Proxy[EnumText.enumForum_Forums_FieldStatus]%>
                    </td>
                    <td class="ctd" style="width: 351px">
                    ...
                    <td>
                        <span>
                            <img src="../../Images/help.gif" style="margin-bottom: -2px;" alt="" onmouseover="showHelp('divHelp','<%=Proxy[EnumText.enumForum_Forums_HelpStatus]%>');"
                                onmouseout="closeHelp('divHelp');" /></span>
                    </td>
                </tr>
                <tr>
                    <td class="ttd">
                        <%=Proxy[EnumText.enumForum_Forums_Moderator]%>
                    </td>
                    <td class="ctd" style="width: 351px">
                        <div>
                            <table>
...
<asp:Content ID="ContentThickBox" ContentPlaceHolderID="cphThickBox" runat="server">
    <%-- <div id="" style="position: absolute; display: none; border: solid 3px #aaa; padding: 5px 5px 5px 5px; background-color:#fff; overflow-y:scroll;">
        <div>
             <div style="float: right;font-size: 1.1em;">
                    <span class="divh-header-spanclose">[<a class="linkClose" href="#" onclick="javascript:WindowClose('divThickInner','divThickOuter');">Close</a>]</span>
             </div>
        </div>
        <div>
                ...
                <div class="divh-header">
                    <div style="float: left; font-size: 1.1em;">
                        <span class="divh-header-spantitle">
                            <asp:Label ID="lblSelectUserTitle" runat="server"></asp:Label>
                        </span>
                    </div>
                </div>
                <br />
                        ...
                        <center>
                            <table class="form-table">
                                <tr>
                                    <td>
                                        <div class="ttd">
                                            <%=Proxy[EnumText.enumForum_User_QueryEmailOrDisplayName] %></div>
                                    </td>
                                    <td class="ctd">
