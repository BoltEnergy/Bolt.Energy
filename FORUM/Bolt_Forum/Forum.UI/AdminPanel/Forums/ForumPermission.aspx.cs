...
{
    public partial class ForumPermission : Com.Comm100.Forum.UI.AdminPanel.AdminBasePage
    {
        ...
        protected override void InitLanguage()
        {
            try
            {
                ...
                Master.Page.Title = Proxy[EnumText.enumForum_Permission_ForumPermissionSettingsTitle];
                ...
                #region Permission Item Instraction
                this.lblViewForum.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipAllowViewForum];
                this.lblViewTopic.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipAllowViewTopicOrPost];
                this.lblPost.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipAllowPostTopicOrPost];
                this.lblIntervalPost.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipMinInterValTimeForPosting];
                this.lblPostLength.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipMaxLengthOfTopicOrPost];
                //this.lblHTML.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipAllowHTML];
                this.lblURL.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipAllowLink];
                this.lblImage.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipAllowInsertImage];
                this.lblPostNotModeration.Text = Proxy[EnumText.enumForum_Permission_ForumToolTipPostModerationNotNeeded];
                #endregion Permission Item Instraction
            }
            catch (Exception ex)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.lblMessage.Visible = true;
                this.lblMessage.Text = ErrorLoad + ex.Message;
        ...
        #endregion Check Permission Enable
        ...
        #region Show Group Use JS
        public void ShowGroup(EnumUserGroupType type)
        {
        ...
        void UserGroupsBind()
        {
            try
            {
                if (ViewState[VSKEY_UserGroupsInForum] == null)
                {
                    ...
                    var groups = from g in groupsInForum
                                 select new { Name = Server.HtmlEncode(g.Name), UserGroupId = g.UserGroupId };
                    this.rpUserGroup.DataSource = groups;
        ...
        void ReputationGroupsBind()
        {
            try
            {
                if (ViewState[VSKEY_ReputationGroupsInForum] == null)
                {
                    ...
                    var groups = from g in groupsInForum
                                 select new { Name = Server.HtmlEncode(g.Name), GroupId = g.GroupId };
                    this.rpReputationGroups.DataSource = groups;
        ...
        protected void NotAddForumUserGroupBind()
        {
            ...
            var userGroups = from g in userGroupNotInForum
                             select new { Name = Server.HtmlEncode(g.Name), UserGroupId = g.UserGroupId };
            this.rpUserGroupNotInForum.DataSource = userGroups;
        ...
        protected void NotAddForumReputationGroupBind()
        {
            ...
            var reputationGroups = from g in reputationGroupsNotInForum
                             select new { Name = Server.HtmlEncode(g.Name), GroupId = g.GroupId };
            this.rpReputationGroupsNotInForum.DataSource = reputationGroups;
        ...
        protected void ibtnGroupDel_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblMessage.Text = Proxy[EnumText.enumForum_Permission_ForumDeleteUserGroupFromForumErrorMessage] + ex.Message;
                this.lblMessage.Visible = true;
            }
        }
        protected void ibtnReputatioinGroupDel_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblMessage.Text = "Deleting Reputation Group From Forum Error:" + ex.Message;
                this.lblMessage.Visible = true;
            }
        }
        #endregion
        ...
        void PermissionBind(int groupId, EnumUserGroupType type)
        {
            try
            {
                ...
                this.btnSave1.CommandArgument = this.btnSave2.CommandArgument = groupId.ToString();
                if (type == EnumUserGroupType.UserGroup)
