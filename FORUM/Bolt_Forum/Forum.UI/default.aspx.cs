...
{
    public partial class Default : SearchBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IfError)
            {
                try
                {                   
                    ViewState["forumId"] =  WebUtility.GetAppSetting("forumId");
                    ...
                    Master.Page.Title = WebUtility.GetAppSetting("ForumName");
        ...
        protected void RepeaterForum_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                HtmlControl puser = (HtmlControl)e.Item.FindControl("user_name");
                HtmlControl dvinitial = (HtmlControl)e.Item.FindControl("dvinitial");
                //Label lblinitial = (Label)e.Item.FindControl("lblinitial");

                
                
                TopicWithPermissionCheck data = (TopicWithPermissionCheck)e.Item.DataItem;
                puser.Attributes.Add("title", data.PostUserOrOperatorName);

                dvinitial.Attributes.Add("class","bolt_posted_avatar bolt-"+ WebUtility.GetInitialClass(data.PostUserOrOperatorName));
        ...
        private void InitPageSize()
        {
            ...
            aspnetPager.PageSize = repPageSize;
            aspnetPagerTop.PageSize = repPageSize;
        }
