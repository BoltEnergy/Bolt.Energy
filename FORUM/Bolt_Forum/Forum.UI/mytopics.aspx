<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.Master" AutoEventWireup="true"
    CodeBehind="mytopics.aspx.cs" Inherits="Com.Comm100.Forum.UI.mytopics" %>
    ...
    <body>    
        ...
        <div class="pos_bottom_5">
            <div class="toolbar">
                ...
                <div class="divMsg" style="padding-left: 110px;">
                    <asp:Label ID="lblMessage" runat="server" CssClass="errorMsg clsdeleteerror" EnableViewState="False"></asp:Label>
                </div>
            </div>
                ...
                <table width="100%" class="bolt_topic_list" border="0" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr>
                            ...
                            <th width="80" align="center" class="bolt_only_dst">Delete</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <asp:Repeater ID="rptAnnoucement" runat="server" EnableViewState="false" Visible="false">
                                <ItemTemplate>
                   ...
                   <%--     <td class="row_announcements" align="center">
                            ...
                            <tr>
                                <td class="row8" colspan="6" style="display: none;">
                                    <p>
                                        <%=Proxy[EnumText.enumForum_Public_Topics]%>
                                    </p>
                                </td>
                            </tr>
                            ...
                            <asp:Repeater ID="RepeaterForum" runat="server">
                                <ItemTemplate>
                                    <tr id="<%#("tr"+Convert.ToString(Eval("TopicId")))%>"                                        
                                        class="<%#((this.RepeaterForum.Items.Count+1)%2 == 0) ? "trEven" : "trOdd"%>"                                       
                                        ...
                                        <td class="bolt_only_dst" align="left">                                            <p>
                                        ...
                                        <td class="bolt_only_dst" align="center">
                                            <asp:LinkButton ID="lbdelete" runat="server" Visible="false" CommandName="Delete">Delete</asp:LinkButton>
                                            <a topicid="<%#(Convert.ToString(Eval("TopicId")))%>"  
                                                class="deletepost" href="javascript:void();"><img src="images/icon-delete.png"></a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
