...
{
    public partial class Forum : SearchBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                if (!IfError)
                {
                    try
                    {
                        ...
                        this.lblForumName.Text = System.Web.HttpUtility.HtmlEncode(ReplaceProhibitedWords(tmpForum.Name));
        ...
        /* create by surinder on 3/1/217 for manual sorting*/
            ...
            if (CheckIfAllowViewForumPermission(Convert.ToInt32(ViewState["forumId"])))
            {
                if (IfFeatured == false)
                {
                    ...
                    if (this.IfAdmin() || this.IfModerator())
                        ...
                        out recordsCount);
                    /*updated on 3/1/2017 by surinder admin sort function*/
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            if (!IfError)
            {
                try
                {
                    ...
                    //Response.Redirect("~/SearchResult.aspx?key=" + System.Web.HttpUtility.UrlEncode(MyEncode(this.tbSearch.Value))
                    //   + "&time=" + System.Web.HttpUtility.UrlEncode(MyEncode("0"))
                    //   + "&in=" + System.Web.HttpUtility.UrlEncode(MyEncode("0"))
                    //   + "&id=" + System.Web.HttpUtility.UrlEncode(MyEncode("f_" + Convert.ToInt32(Request.QueryString["forumId"]).ToString()))
                    //   + "&ifPost=" + System.Web.HttpUtility.UrlEncode(MyEncode("1"))
                    //   + "&siteid=" + SiteId
                    //   , false);
                    ...
                    //UPDATED BY SURINDER
                    //string query = MyEncode("key=" + System.Web.HttpUtility.UrlEncode(src.Value)
                    //                    + "&time=" + System.Web.HttpUtility.UrlEncode("0")
                    //                    + "&in=" + System.Web.HttpUtility.UrlEncode("0")
                    //                    + "&id=" + System.Web.HttpUtility.UrlEncode("f_" + Convert.ToInt32(Request.QueryString["forumId"]).ToString())
                    //                    + "&ifpost=" + System.Web.HttpUtility.UrlEncode("1")
                    //                    + "&forumid=" + ForumId
                    //                    + "&siteid=" + SiteId);
